...
\begin{figure}[H]
    ...
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/meshConvergence_RE100_P.eps}
    }
...
\begin{figure}[H]
    ...
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/convergence_dUdR_Y000_RE100.eps}
    }
    \quad
    \subfigure[V-velocity sensitivity on $x = 0.75$]
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/convergence_dVdR_X075_RE100.eps}
    }
    \\
    \subfigure[Pressure sensitivity on $y = 0.0$]
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/convergence_dPdR_Y000_RE100.eps}
    }
...
\begin{figure}[H]
    ...
    \subfigure[U-velocity sensitivity on $y = 0.0$]
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/validation_dUdR_Y000_RE100.eps}
    }
    \quad
    \subfigure[U-velocity sensitivity on $y = 0.20$]
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/validation_dUdR_Y020_RE100.eps}
    }
    \\
	\subfigure[V-velocity sensitivity on $x = 0.5$]
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/validation_dVdR_X050_RE100.eps}
    }
    \quad
    \subfigure[V-velocity sensitivity on $x = 0.75$]
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/validation_dVdR_X075_RE100.eps}
    }
    \\
	\subfigure[Pressure sensitivity on $y = 0.0$]
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/validation_dPdR_Y000_RE100.eps}
    }
    \quad
    \subfigure[Pressure sensitivity on $y = 0.20$]
    {
    \includegraphics[width=6.5cm]{Chapter_4/figure/flow_over_cylinder/validation_dPdR_Y020_RE100.eps}
    }
