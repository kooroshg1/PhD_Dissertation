...
The boundary conditions for the sensitivity analysis are defined by differentiating the original boundary conditions of the governing equations. These conditions do not depend on the design variables and therefore have zero values. These conditions are applied using a 4th order approximation on the boundaries of sensitivity equation. Obtaining the governing equations and boundary conditions, it is possible to solve the sensitivity equations.
...
\begin{figure}[H]
    ...
    \\
	\subfigure[V-velocity sensitivity on $x = 1.50$]
    {
